...
class SendBirdTools:NSObject {
   ...
   @objc static func getInstance(sendBirdAppId:String?) -> SendBirdTools? {
   ...
   @objc func loginAccountFrom(sendBirdOpenChannelUrl:String, customLoginVC: LoginViewController?, loginCallback: ((_ userInfo:UserInfoObject) -> Void)?) {
   ...
   @objc func sendDiscussTo(vc:UIViewController, sendBirdOpenChannelUrl:String, customSendDiscussVC: SendDiscussViewController?, according:DiscussAccordingObject?, sendDiscussCallback: ((_ discuss:DiscussObject?) -> Void)?) {
...
//        UIApplication.shared.keyWindow?.rootViewController?.present(defaultVC, animated: true, completion: nil)
   ...
   @objc func queryDiscussFrom(vc:UIViewController, sendBirdOpenChannelUrl:String, sendBirdRepostOpenChannelUrl:String, sendBirdLikeOpenChannelUrl:String, userInfo:UserInfoObject, customQueryDiscussVC: QueryDiscussViewController?, accordingClickCallback: ((_ discuss:DiscussObject) -> Void)?) {
        ...
        if let navi = vc.navigationController {
            ...
            vc.present(ThemeWNavigationController(rootViewController: defaultVC), animated: true, completion: nil)
        }
   ...
   @objc func getUserInfo() -> UserInfoObject {
